...
This documents describes the procedures to detect outlying points in a time course with examples on experimental data measured directly on the plants or indirectly via image analysis for example. 
