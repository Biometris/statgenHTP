...
* the smoothing parameter `mylocfit`. It is the parameter `nn` from the locfit package (Nearest neighbor component of the smoothing parameter). This parameter values range grom 0 to 1, with thehigher the value, the smoother the curve.
