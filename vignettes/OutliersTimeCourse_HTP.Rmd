...
Here, the `geno.decomp` option is also to split the plants of each genotype into well watered and drought. The outlier detection is run per treatment with a narrow angle threshold
