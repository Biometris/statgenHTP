...
We will use the `fit.splineOut` previously created which contains the p-spline prediction without the time course outliers. We could estimate the maximum value of the trait in the beginning of the time course. 

```{r paramVator, echo=TRUE, message=FALSE, warning=FALSE, eval=FALSE}
paramVator1 <-
