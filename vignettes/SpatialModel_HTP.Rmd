...
In this case, time point "2017-05-14" has only 488 observation, less than half of the total number of observation. It can bias the modelling at this time point and one may want to remove it before running the spatial analysis. 
