...
```
Although we have available information at population, genotype and plot levels, this function only extract information at genotype and plot levels. Nevertheless, we are generally interested in the genotype level. For example, in the paper by @Perez2022, they extracted three features: the maximum spatially corrected leaf area (from estimated genotype-specific growth curves), the maximum speed rate (from the first derivative of the estimated genotype-specific growth curves), and the area under the estimated genotype-specific deviations, as follows 

```{r paramPhenoGenoPred, fig.height=2, fig.width=4, echo=TRUE, message=FALSE, warning=FALSE, eval=TRUE}
## Estimate maximum spatially corrected leaf area (from estimated genotype-specific growth curves)
...
## Estimate maximum speed rate (from the first derivative of the estimated genotype-specific growth curves)
...
## Estimate area under the estimated genotype-specific deviations.
