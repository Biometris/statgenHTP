...
When SpATS is used for modeling, an extra spatial term is included in the model. This spatial component is composed using the `PSANOVA` function in the SpATS package which uses 2-dimensional smoothing with P-splines as described in @Lee2013 and in @RodAlv2017. 
...
ADD EXPLANATION + ALSO NOT POSSIBLE WITH ASREML
...
DESCRIBE OPTION predictChecks FOR PREDICTING CHECK GENOTYPES
...
DESCRIBE OPTION plotChecks FOR PLOTTING CHECK GENOTYPES
