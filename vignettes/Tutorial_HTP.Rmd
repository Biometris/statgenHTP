...
vignette: |
  %\VignetteIndexEntry{Tutorial} %\VignetteEncoding{UTF-8} %\VignetteEngine{knitr::rmarkdown}
---
...
using the option `extraFixedFactors`. The model can also be fitted following a resolvable 
...
> *TO NOTE: when extraFixedFactors are used, the standard errors from SpATS are wrong. We are waiting for an update of the package.*
