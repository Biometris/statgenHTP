...
EPPN^2020^ project to meet the needs for automated analyses of HTP data.
...
in the original `data.frame` (called "PhenovatorDat1"). The parameter `experimentName`
...
By using the parameter `genotypes` a selection of genotypes can be plotted.
...
goodness-of-fit criterion, either AIC or BIC, on 20% on the time points or at least 10 
