...
summary(rootTP)
```
The "rootTP" object just created is a `list` with xx items, one for each time points 
 in the original `data.frame` (called "RootDat1"). 

```{r rawRoot, include=TRUE, fig.height=2, fig.width=6, fig.align = 'center', eval=FALSE}
plot(rootTP, 
     traits = "tipPos_y",
     plotType = "raw",
     genotypes = c("2", "8"))
