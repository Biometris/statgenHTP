...
The overall structure of the package is in 4 main parts:  
1. Outliers detection: time points -  *Tutorial_HTP_xxx*
2. Correction for spatial trends - *Tutorial_HTP_xxx* 
3. Outliers detection: time course - *Tutorial_HTP_xxx*
4. Parameter extraction - *Tutorial_HTP_xxx*  
...
```{r headdatagh, echo=FALSE, message=FALSE, eval=FALSE}
...
```{r headdataroot, echo=FALSE, message=FALSE, eval=FALSE}
