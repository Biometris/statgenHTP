...
the genotypes using the water scenario. We can already visualize the difference between the irrigation levels for two genotypes: the leaf area in WW is bigger than in WD and the slope of the leaf area progression also seems to be bigger:
