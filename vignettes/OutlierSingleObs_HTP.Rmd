...
-   the smoothing parameter `mylocfit`. This is the parameter `nn` from the locfit package (Nearest neighbor component of the smoothing parameter). This parameter values range from 0 to 1, with the higher the value, the smoother the curve.
