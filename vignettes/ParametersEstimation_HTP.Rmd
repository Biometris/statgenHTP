...
For this example, we will use the raw data from the RootPhAir, corrected for time point outliers (see **statgenHTP tutorial: 2. Outlier detection Time points**) and time course outliers (see **statgenHTP tutorial: 4. Outlier detection Time courses**). We will fit P-splines at the plant level on a subset of genotypes.
