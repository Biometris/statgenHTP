...
The data from the Phenovator platform have been corrected for spatial trends and time points outliers have been removed (see [*statgenHTP tutorial: 2. Outlier detection for single observations*](OutlierSingleObs.html) and [**statgenHTP tutorial: 3. Correction for spatial trends**](SpatialModel_HTP.html)). At this stage, the cleaned and corrected data are used:
...
outRoot <- detectSerieOut(corrDat = noCorrRoot,
...
noCorrRootOut <- removeSerieOut(dat = noCorrRoot,
