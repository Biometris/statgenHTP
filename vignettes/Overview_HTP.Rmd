...
To model this sample of time-series of spatially corrected plant/plot trajectories a P-spline-based hierarchical data model (PsHDM) is used [@Perez2022]. To fit the PsHDM, we use the `fitSplineHDM` function with cubic (`bdeg` $= 3$) B-spline basis functions with `nseg` $= 7$ segments, and second order penalties (`pord`$=2$) to represent functions at the three levels of the hierarchy.
