...
if (at_home()) {
  ...
  expect_equal(varAs3[["varGen"]],
               c(1.65397675029422e-09, 0.000312114772570697, 3.1433085674295e-05,
                 0.000626495864056879, 0.000479038160766828))
  expect_equal(varAs3[["varRes"]],
               c(0.00103373539437683, 0.000514334135629192, 0.000902330012987955,
                 0.000336341338876986, 0.000284339025219647))

  expect_equal(varAs4[["varGen"]],
               c(1.38646720134525e-09, 1.00887137199852e-09, 0.000147384723749649,
                 0.000729521481678914, 0.000373421169164799))
  expect_equal(varAs4[["varRes"]],
               c(0.00086654193834238, 0.00063054456202173, 0.000456828756440842,
                 0.000173447996381509, 0.000389710248725436))
}
